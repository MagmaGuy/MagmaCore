...
import com.magmaguy.easyminecraftgoals.v1_21_R4.passenger.PassengerOffset;
...
import com.magmaguy.easyminecraftgoals.v1_21_R4.pathfinding.NativePathfindingGoal;
...
public class NMSAdapter extends com.magmaguy.easyminecraftgoals.NMSAdapter {
    ...
    public float getConsumptionSeconds(org.bukkit.inventory.ItemStack item) {
        var nativeItem = org.bukkit.craftbukkit.v1_21_R4.inventory.CraftItemStack.asNMSCopy(item);
    ...
    public org.bukkit.inventory.ItemStack withConsumptionSeconds(org.bukkit.inventory.ItemStack item, float seconds) {
        ...
        return org.bukkit.craftbukkit.v1_21_R4.inventory.CraftItemStack.asBukkitCopy(nativeItem);
    }
