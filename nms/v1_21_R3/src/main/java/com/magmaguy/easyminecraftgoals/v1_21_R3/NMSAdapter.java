...
import com.magmaguy.easyminecraftgoals.v1_21_R3.pathfinding.NativePathfindingGoal;
...
public class NMSAdapter extends com.magmaguy.easyminecraftgoals.NMSAdapter {
    private com.magmaguy.easyminecraftgoals.v1_21_R3.mind.NativeMindHost mindHost;
    @Override public com.magmaguy.magmacore.ai.MindHost createMindHost(org.bukkit.NamespacedKey identity,
        ...
        mindHost = new com.magmaguy.easyminecraftgoals.v1_21_R3.mind.NativeMindHost(identity, failures, actions);
        return mindHost;
    }
    @Override public boolean isMindBody(Entity entity) { return com.magmaguy.easyminecraftgoals.v1_21_R3.mind.NativeMindHost.isMindCarrier(entity); }
    ...
    public float getConsumptionSeconds(org.bukkit.inventory.ItemStack item) {
        var nativeItem = org.bukkit.craftbukkit.v1_21_R3.inventory.CraftItemStack.asNMSCopy(item);
    ...
    public org.bukkit.inventory.ItemStack withConsumptionSeconds(org.bukkit.inventory.ItemStack item, float seconds) {
        ...
        return org.bukkit.craftbukkit.v1_21_R3.inventory.CraftItemStack.asBukkitCopy(nativeItem);
    }
