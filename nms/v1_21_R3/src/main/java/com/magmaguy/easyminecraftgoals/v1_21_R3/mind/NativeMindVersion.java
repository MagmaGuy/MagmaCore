package com.magmaguy.easyminecraftgoals.v1_21_R3.mind;
...
final class NativeMindVersion {
    ...
    static boolean sunlightExposure(Mob mob) {
        ...
        return susceptible && mob.level().isDay()
                && mob.getLightLevelDependentMagicValue() > .5F
                && !mob.isInWaterRainOrBubble() && !mob.isInPowderSnow && !mob.wasInPowderSnow
