...
public class NMSAdapter extends com.magmaguy.easyminecraftgoals.NMSAdapter {
    private com.magmaguy.easyminecraftgoals.v1_21_R7_common.mind.NativeMindHost mindHost;
    @Override public com.magmaguy.magmacore.ai.MindHost createMindHost(org.bukkit.NamespacedKey identity,
        ...
        mindHost = new com.magmaguy.easyminecraftgoals.v1_21_R7_common.mind.NativeMindHost(identity, failures, actions);
        return mindHost;
    }
    @Override public boolean isMindBody(Entity entity) { return com.magmaguy.easyminecraftgoals.v1_21_R7_common.mind.NativeMindHost.isMindCarrier(entity); }
